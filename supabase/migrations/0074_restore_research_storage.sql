-- =============================================================================
-- 0074 — restore the Research tool's storage (originally 0039 on the
-- never-merged feat/reviewed-full-day-rollover branch; main dropped the
-- orphaned empty tables in 0071 before the tool itself was restored).
--
